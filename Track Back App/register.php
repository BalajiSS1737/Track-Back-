    ...
    if (empty($firstName) || empty($lastName) || empty($email) || empty($password)) {
        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                $stmt = $pdo->prepare("INSERT INTO users (first_name, last_name, email, phone, password, status, created_at) VALUES (?, ?, ?, ?, ?, 'active', NOW())");
...
<head>
    ...
    <title>Register - Track Back App</title>
            ...
            <form class="auth-form" id="registerForm" method="POST">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="firstName" name="firstName" required placeholder="Enter first name" value="<?php echo htmlspecialchars($_POST['firstName'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        <label for="lastName">Last Name</label>
                        <input type="text" id="lastName" name="lastName" required placeholder="Enter last name" value="<?php echo htmlspecialchars($_POST['lastName'] ?? ''); ?>">
                    </div>
                </div>
